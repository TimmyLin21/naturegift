  ...
  <form class="row g-3">
    ...
    <div class="col-6">
      ...
      <input
        ...
        v-model="cacheProduct.carbohydrate"
      >
    </div>
    <div class="col-6">
      <label
