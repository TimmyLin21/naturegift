    ...
    <div class="row g-5">
      <div class="col-md-5 pt-md-7">
        <div class="bg-primary shadow-lg p-3 mx-auto">
          <h2 class="mb-4">Thank you <br> for your purchase!</h2>
          <router-link to="/" class="btn btn-outline-success me-3">Go to Home</router-link>
          <router-link to="/products" class="btn btn-secondary">Keep shopping</router-link>
        </div>
      </div>
      <section class="col-12 col-md-7 mb-4">
        <div class="c-table">
          <h2 class="text-white py-3">Order Info</h2>
          <div class="c-table__body">
            <p><span class="fw-bold">Date:</span><span>{{$filters.date(order.create_at)}}</span></p>
            ...
            <p class="mb-0"><span class="fw-bold">Subtotal:</span>
              <span>{{order.total}}
                <BIconCaretDownFill
            ...
            <div id="collapseOne" class="accordion-collapse collapse mt-3">
            <p class="fw-bold border-0">Order Items</p>
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                <tr v-for="item in order.products" :key="item.id" class="align-middle">
                  <td width="20%">
