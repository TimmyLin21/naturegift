      ...
      <section class="col-12 col-md-5 pt-3">
        ...
        <div class="border rounded-top-10px p-3 text-start border-bottom-0">
          <div class="form-check">
            ...
            name="paywith"
            v-model="payMethod">
            <label for="creditRadio" class="form-check-label">Credit Card</label>
          </div>
        </div>
        <div class="border rounded-bottom-10px p-3 text-start mb-4">
          <div class="form-check">
            ...
            name="paywith"
            v-model="payMethod">
            <label for="paypalRadio" class="form-check-label">Paypal</label>
          </div>
        </div>
        <button class="c-btn" type="button" @click="postPay">
